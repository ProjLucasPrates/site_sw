        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="form_insere.php"> <i class="menu-icon ti-email"></i>Insert New Customer</a>
                    </li>
                    <li>
                        <a href="#"> <i class="menu-icon fa fa-area-chart"></i>Search a Customer</a>
                    </li>
                    <li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            ...
                            <a class="nav-link" href="saiu.php"><i class="fa fa-power-off"></i> Sair</a>
                        </div>
                    </div>                    
                </div>
            </div>
